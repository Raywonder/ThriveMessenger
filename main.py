...
class MainFrame(wx.Frame):
    ...
    def __init__(self, user, sock):
        ...
        super().__init__(None, title="", size=(400,380)); self.user, self.sock = user, sock; self.task_bar_icon = None; self.is_exiting = False; self._directory_dlg = None; self._bot_rules_dlg = None; self._group_policy_dlg = None; self._group_call_dlg = None; self._group_list_dlg = None; self._group_chats = {}
    ...
    def _build_menu_bar(self):
        ...
        self.mi_group_chats = conversations_menu.Append(wx.ID_ANY, "Group Chats")
